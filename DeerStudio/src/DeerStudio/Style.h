...
void SetupVSCodeStyle() {
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    colors[ImGuiCol_SliderGrab] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.16f, 0.64f, 0.40f, 1.00f);  // #28A745
    ...
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.16f, 0.64f, 0.40f, 1.00f);  // #28A745
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.14f, 0.56f, 0.36f, 1.00f);  // #238636
    colors[ImGuiCol_Tab] = ImVec4(0.12f, 0.12f, 0.12f, 1.00f);  // #1E1E1E
    colors[ImGuiCol_TabHovered] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    colors[ImGuiCol_TabActive] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    ...
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.16f, 0.64f, 0.40f, 1.00f);  // #28A745
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.18f, 0.70f, 0.44f, 0.35f);  // #2ECC71 with transparency
    colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);  // Yellow
    colors[ImGuiCol_NavHighlight] = ImVec4(0.18f, 0.70f, 0.44f, 1.00f);  // #2ECC71
    ...
    colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);  // Dark grey with transparency
